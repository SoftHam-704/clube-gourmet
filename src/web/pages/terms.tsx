        ...
        <div className="bg-[#0a0a0a] min-h-screen text-white text-justify">
            ...
            <section className="pt-32 pb-20 relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
                    <span className="text-[#00ff88] font-mono text-sm tracking-widest uppercase mb-4 block">// Legal</span>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 bg-[#111]/50 border border-[#222] p-8 lg:p-16 space-y-12">
                    {sections.map((section, i) => (
                        <div key={i} className="space-y-4">
                            <h2 className="text-2xl font-bold text-white border-l-2 border-[#00ff88] pl-6">{section.title}</h2>
                    ...
                    <div className="pt-12 border-t border-[#222]">
                        <p className="text-[#666] text-sm">
                            Para dúvidas sobre nossos termos, entre em contato através do e-mail <a href="mailto:legal@clubempar.com" className="text-[#00ff88] hover:underline">legal@clubempar.com</a>.
                        </p>
                    </div>
                </div>
            </section>
