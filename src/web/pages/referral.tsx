    ...
    return (
        <div className="bg-[#1a4d2e] min-h-screen text-white selection:bg-[#c9a961] selection:text-[#0a0a0a]">
            ...
            // PROGRAMA DE PRESTÍGIO
                    ...
                    <h1 className="font-heading text-6xl sm:text-7xl lg:text-9xl font-black text-white leading-[0.8] tracking-tighter mb-12 uppercase">
                        Indique e<br />
            ...
            <section className="py-40 bg-[#1a4d2e] relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-24">
                        <h2 className="font-heading text-4xl lg:text-6xl font-black uppercase tracking-tighter">Recompensas de <span className="text-gradient-gold">Destaque</span></h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-12">
                        {REWARDS.map((reward, i) => (
                            <div key={i} className="p-10 bg-[#0a0a0a]/60 backdrop-blur-3xl border border-[#c9a961]/10 relative group hover:border-[#c9a961] transition-all duration-700">
                                ...
                                <h3 className="text-2xl font-heading font-black mb-6 text-[#c9a961] group-hover:text-white transition-colors uppercase tracking-widest">{reward.title}</h3>
            ...
            <section className="py-40 bg-[#0a0a0a] relative overflow-hidden">
                <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                    <div className="inline-block p-12 bg-[#1a4d2e]/10 border border-[#c9a961]/20 relative">
                        ...
                        <h3 className="text-white font-heading text-3xl font-black mb-8 uppercase tracking-widest">Seu Link de Convite</h3>
