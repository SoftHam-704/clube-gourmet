...
const StatCard = ({ label, value, trend, icon, loading }: { label: string; value: string; trend?: string; icon: React.ReactNode; loading?: boolean }) => (
    <div className="bg-[#0a0a0a]/60 backdrop-blur-2xl border border-[#c9a961]/10 p-8 relative group overflow-hidden">
        ...
        <div className="flex flex-col gap-1">
            ...
            {loading ? (
                <div className="h-10 w-32 bg-[#c9a961]/10 animate-pulse mt-2" />
            ) : (
        ...
        <AdminLayout title="Dashboard">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#0a0a0a]/60 backdrop-blur-2xl border border-[#c9a961]/10 overflow-hidden">
                    ...
                    <div className="p-0">
                        {loading ? (
                            <div className="p-20 text-center font-mono text-[#c9a961]/40 text-[10px] uppercase tracking-widest animate-pulse">Sincronizando Usuários...</div>
                        ) : data?.recentMembers.length === 0 ? (
                            <div className="p-20 text-center font-mono text-[#c9a961]/40 text-[10px] uppercase tracking-widest">Nenhum membro encontrado</div>
                        ) : (
                                ...
                                <div key={i} className="flex items-center justify-between p-6 border-b border-[#c9a961]/5 hover:bg-[#c9a961]/5 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[#d4c5a0]/40 text-[10px] font-mono uppercase truncate max-w-[150px]">{user.email}</span>
                                        </div>
                                    </div>
                                    <div className="text-right flex flex-col items-end gap-1">
                                        <span className="text-[#c9a961] text-[10px] font-black tracking-widest uppercase">{user.plan || "Sem Plano"}</span>
