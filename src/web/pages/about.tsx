        ...
        <div className="bg-[#1a4d2e] min-h-screen text-white">
            ...
            <section className="pt-32 pb-20 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <span className="text-[#c9a961] font-mono text-sm tracking-widest uppercase mb-4 block">// Sobre Nós</span>
            ...
            <section className="py-20 border-y border-[#222] bg-[#111]">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                        <div>
                            <div className="font-mono text-4xl font-bold text-[#c9a961]">2022</div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8 pt-8">
                                <div className="p-6 border border-[#222] bg-[#111]/50">
                                    <h3 className="text-[#c9a961] font-mono text-sm uppercase tracking-widest mb-3">// Missão</h3>
                        ...
                        <div className="relative">
                            ...
                            <div className="aspect-square border border-[#222] bg-[#111] relative flex items-center justify-center">
                                ...
                                {/* Corner accents */}
                                <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#c9a961]" />
            ...
            <section className="py-32 bg-[#111] relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center mb-16">
                    <span className="text-[#c9a961] font-mono text-sm tracking-widest uppercase mb-4 block">// Nossos Valores</span>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="p-8 border border-[#222] bg-[#1a4d2e] hover:border-[#333] transition-all group">
