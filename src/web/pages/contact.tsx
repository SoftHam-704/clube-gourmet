    ...
    return (
        <div className="bg-[#1a4d2e] min-h-screen text-white selection:bg-[#c9a961] selection:text-[#0a0a0a]">
            ...
            // CANAL EXCLUSIVO
                    ...
                    <h1 className="font-heading text-5xl sm:text-6xl lg:text-8xl font-black text-white leading-[0.85] tracking-tighter mb-12 uppercase text-center lg:text-left">
                        Sempre à<br />
                        <span className="text-gradient-gold animate-gradient">Sua Disposição.</span>
                    </h1>

                    <p className="text-[#d4c5a0]/70 text-2xl lg:text-3xl font-light max-w-3xl leading-relaxed italic font-heading">
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-stretch">
                        ...
                        <div className="space-y-16">
                            <div className="space-y-6">
                                ...
                                <h2 className="font-heading text-4xl lg:text-6xl font-black text-white tracking-tighter uppercase whitespace-pre-line">
                        ...
                        <div className="relative">
                            <div className="bg-[#0a0a0a]/80 backdrop-blur-3xl p-10 lg:p-16 border border-[#c9a961]/20 relative shadow-[0_50px_100px_rgba(0,0,0,0.6)]">
                                ...
                                <h3 className="text-white font-heading text-3xl font-black mb-12 uppercase tracking-tight">Envie sua Mensagem</h3>
            ...
            <section className="py-24 bg-[#0a0a0a] border-y border-[#c9a961]/10">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center sm:text-left flex flex-col sm:flex-row justify-between items-center gap-12">
                    <div className="space-y-4">
                        <h4 className="text-[#c9a961] font-heading text-2xl font-bold uppercase tracking-widest">Atendimento 24/7</h4>
