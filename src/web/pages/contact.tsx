            ...
            <section className="pt-32 pb-20 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-20">
                        <div>
                            <span className="text-[#c9a961] font-mono text-sm tracking-widest uppercase mb-4 block">// Contato</span>
                            ...
                            <div className="space-y-12 pt-8">
                                <div>
                                    ...
                                    <a href="mailto:suporte@clubempar.com" className="text-2xl font-bold hover:text-[#c9a961] transition-colors">suporte@clubempar.com</a>
                                </div>

                                <div>
                                    <h3 className="text-[#666] font-mono text-xs uppercase tracking-widest mb-4">Comercial & Parcerias</h3>
                                    <a href="mailto:parcerias@clubempar.com" className="text-2xl font-bold hover:text-[#c9a961] transition-colors">parcerias@clubempar.com</a>
                                </div>
                                ...
                                <div className="pt-8 flex gap-6">
                                    {['Instagram', 'LinkedIn', 'Twitter'].map(social => (
                                        <a key={social} href="#" className="px-4 py-2 border border-[#222] text-[#666] text-xs font-mono uppercase hover:border-[#c9a961] hover:text-[#c9a961] transition-all">
                                            {social}
                                        </a>
                                    ))}
                                </div>
                                ...
                                <form className="space-y-6">
                                    <div className="grid sm:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" className="w-full px-4 py-3 bg-[#1a4d2e] border border-[#222] focus:border-[#c9a961] outline-none transition-all font-mono text-sm" placeholder="Seu nome" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[#666] text-xs font-mono uppercase tracking-widest">E-mail</label>
                                            <input type="email" className="w-full px-4 py-3 bg-[#1a4d2e] border border-[#222] focus:border-[#c9a961] outline-none transition-all font-mono text-sm" placeholder="seu@email.com" />
                                        </div>
                                    </div>

                                    <div className="space-y-2">
                                        <label className="text-[#666] text-xs font-mono uppercase tracking-widest">Assunto</label>
                                        <select className="w-full px-4 py-3 bg-[#1a4d2e] border border-[#222] focus:border-[#c9a961] outline-none transition-all font-mono text-sm appearance-none cursor-pointer">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea rows={5} className="w-full px-4 py-3 bg-[#1a4d2e] border border-[#222] focus:border-[#c9a961] outline-none transition-all font-mono text-sm resize-none" placeholder="Como podemos ajudar?"></textarea>
                                    </div>

                                    <button type="button" className="w-full py-4 bg-[#c9a961] text-[#0a0a0a] font-bold uppercase tracking-wider text-sm hover:glow-green transition-all">
                                        Enviar Mensagem
                                    </button>
                                </form>
                            </div>
