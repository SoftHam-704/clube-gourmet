            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link href="/#benefits" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">Benefícios</Link></li>
                            <li><Link href="/how-it-works" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">Como Funciona</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/about" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">Sobre Nós</Link></li>
                            <li><Link href="/faq" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">FAQ</Link></li>
                            <li><Link href="/contact" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">Contato</Link></li>
                            <li><Link href="/partners" className="text-[#666] hover:text-[#00ff88] transition-colors text-sm">Seja um Parceiro</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-[#222] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        ...
                        <Link href="/privacy" className="text-[#444] hover:text-[#00ff88] transition-colors text-xs font-mono">Privacidade</Link>
                    </div>
                </div>
            </div>
        </footer>
